...
//        String ip2 = sc.nextLine();
        ...
        String ip2 = "193.43.7.59";

        boolean maskCheck = check(mask,true);
        boolean ip1Check = check(ip1,false);
        boolean ip2Check = check(ip2,false);
    ...
    private static boolean check(String ip,boolean isMask) {
        String[] s = ip.split("\\.");
        int[] m = new int[s.length];
